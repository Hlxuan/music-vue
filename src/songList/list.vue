<template>
  <div>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="title" label="歌单名称" width="180">
      </el-table-column>
      ...
      <el-table-column prop="style" label="歌单类型"> </el-table-column>
      <el-table-column prop="introduction" label="歌单介绍"> </el-table-column>
      ...
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item label="图片">
          ...
          <el-upload
            ...
            action="http://localhost:8085/music/file/songlist/upload"
